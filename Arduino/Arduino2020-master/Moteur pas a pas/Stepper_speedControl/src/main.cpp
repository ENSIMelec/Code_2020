...
void setup() {
  ...
  pinMode(MS3, OUTPUT);
  pinMode(EN, OUTPUT);
  void resetBEDPins(); //Set step, direction, microstep and enable pins to default states
...
void ReverseStepDefault()
{
  ...
  for(x= 0; x<1000000; x++)  //Loop the stepping enough times for motion to be visible
  {
